...
void SDKTemplate::Scenario8::Button_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
    rootPage->NotifyUser("Hello", NotifyType::StatusMessage);
}

void SDKTemplate::Scenario8::Button_Click_2(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
    rootPage->NotifyUser("Hello", NotifyType::ErrorMessage);
}

void SDKTemplate::Scenario8::Button_Click_3(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
